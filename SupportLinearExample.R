...
source('/Users/Rebecca/pattern_subsets/PMKSfunctions.R')
dat <- read.csv(file = "/Users/Rebecca/pattern_subsets/Support2.csv")
dd <- datadist(dat)
options(datadist='dd')
...
save(results, file = "/Users/Rebecca/pattern_subsets/supportResultsLinearSM.Rda")
save(results.pattern, file = "/Users/Rebecca/pattern_subsets/supportResultsPatternLinearSM.Rda")
...
save(results.pmks, file = "/Users/Rebecca/pattern_subsets/supportResultsPMKSSM.Rda")
save(results.ccsm, file = "/Users/Rebecca/pattern_subsets/supportResultsPatternCCSMSM.Rda")
...
save(all.results, file = '/Users/Rebecca/pattern_subsets/supportSM')
...
save(all.results, file = '/Users/Rebecca/pattern_subsets/supportAdd25pafi.RData')
